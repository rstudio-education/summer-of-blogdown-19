...
1. In your `config.toml` file, update your `permalinks` as follows (also more advice on permalinks in this great post on a ["new post workflow"](https://www.garrickadenbuie.com/blog/blogdown-netlify-new-post-workflow/):
